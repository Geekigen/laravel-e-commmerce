		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				<div class="col-lg-6 welcome-left">
					<h3>Welcome to Digimart laptops</h3>
					<h4 class="my-sm-3 my-2">We sell very affordable ex-uk laptops that will meet ypor perfomance </h4>
					<p>warranty and good perfomance quaranteer.</p>
				</div>
                 ...
                 <div class="col-sm-6 med-testi-grid">
					...
					<div class="row med-testi-left my-5">
						...
						<div class="col-lg-10 col-9 med-testi-txt">
							<h4 class="font-weight-bold mb-lg-1 mb-2">{{ $message->name }}</h4>
							<p>{{ $message->mail }}</p>
						</div>
					</div>
				</div>
